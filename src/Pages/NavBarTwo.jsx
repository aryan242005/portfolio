const NavBarTwo = () => {
    return (
        <div className="flex justify-around w-full h-[70px] fixed top-0 z-50">
            <div className="bg-white w-full pl-[30px] py-[20px] flex items-center border-b-[2px]">
                <img src="/logo.png" className="w-[140px] h-[70px] pt-[10px] mt-[10px] ml-[30px] rounded-[30px]" />
            </div>
            <ul className="font-poppins text-[30px] font-bold w-full bg-white flex justify-around pt-[10px] pb-[20px] border-b-[2px]">
