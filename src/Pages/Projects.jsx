    ...
    return (
        <div id="projects" className="font-poppins px-[30px] xl:pt-[60px]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 min-w-full mx-auto place-items-center items-stretch">
                <div onClick={() => navigate("/devconnect")} className="min-w-full flex flex-col xl:flex-row justify-center items-center border-[1px] border-black rounded-[10px]">
                ...
                <div onClick={() => navigate("/myblog")} className="min-w-full flex flex-col xl:flex-row justify-center items-center border-[1px] border-black rounded-[10px]">
